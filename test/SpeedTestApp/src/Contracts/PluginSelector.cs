    ...
    public class PluginSelector
    {
        ...
        public static void LoadRemactConfigDefault(string pluginName)
        {
            ...
            else if (name.StartsWith("BMS"))
            {
                ...
                conf.AddKnownMessageType(Test2Req.ReadFromBms1Stream, Test2Req.WriteToBms1Stream);
                conf.AddKnownMessageType(Test2Rsp.ReadFromBms1Stream, Test2Rsp.WriteToBms1Stream);
                // TODO Remove dependencies from BMS when running JSON
            }
            else
            {
