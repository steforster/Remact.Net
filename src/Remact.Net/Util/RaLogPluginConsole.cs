...
namespace Remact.Net
{
    public partial class RaLog
    {
        ...
        public class PluginConsole : ILogPlugin
        {
            ...
            /// <summary>
            /// Append the exception message and all inner exception messages to the StringBuilder.
            /// </summary>
            /// <param name="sb">The StringBuilder for appending.</param>
            /// <param name="ex">The exception possibly containing inner exceptions.</param>
