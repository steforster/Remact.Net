...
namespace Remact.Net
{
  ...
  internal class RemactPortClient: RemactPort
  {
    ...
    /*/ <summary>
    /// Link client to application-internal service or service-proxy.
    /// </summary>
    /// <param name="service">a RemactPortService or RemactPortProxy</param>
    public void LinkToService (RemactPort service)
    {
      Disconnect();
      m_Service = service;
      RedirectIncoming = service as IRemotePort;
      //m_ClientProxy = null;
    ...
    public void LinkOutputToRemoteService (string serviceName, IClientConfiguration clientConfig = null)
    {
      ...
      if (!string.IsNullOrEmpty(serviceName))
      {
          ...
          m_Service = m_ClientProxy.PortProxy;
      }
    }
...
*/
    ...
    public override Task<bool> TryConnect()
    {
        ...
        if (RedirectIncoming == null) throw new InvalidOperationException("RemactPortClient is not linked");
...
*/
  ...
  internal class RemactPortClient<TOC> : RemactPortClient where TOC : class
  {
      ...
      {
          RemactMessage msg = new RemactMessage(this, ClientId, NextRequestId,
                                              this, null, payload,
                                              (rsp) =>
                                              {
                                                  TRsp response;
