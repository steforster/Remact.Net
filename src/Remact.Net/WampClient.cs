...
{
    internal class WampClient: IWampRpcV1Server
    {
        private WebSocketClient _wsClient;
        private IWampRpcV1ClientCallbacks _responseHandler;
        ...
        internal void WcfOpenAsync(IWampRpcV1ClientCallbacks responseHandler, Request request)
        {
