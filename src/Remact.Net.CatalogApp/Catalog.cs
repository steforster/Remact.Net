    ...
    class Catalog : IServiceConfiguration, IClientConfiguration
    {
        ...
        public void PeriodicCall(int seconds, TextBox tbStatus)
        {
            ...
            if (SvcRegisterChanged && tbStatus != null)
            {
                ...
                {
                    sb.AppendLine(m_RemactService.InputStateFromNetwork + " CatalogService '" + m_RemactService.Uri + "'");
                }
        ...
        public INetworkServicePortManager DoServiceConfiguration(RemactService service, ref Uri uri, bool isCatalog)
        {
